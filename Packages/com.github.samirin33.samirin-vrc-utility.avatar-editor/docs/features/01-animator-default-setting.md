...
- メニュー: **`samirin33 Editor Tools`** → **`Settings`** → **`Animator Default Setting`**
...
1. 上記メニューまたは Preferences でデフォルト値を設定する
2. Animator ウィンドウを開き、レイヤーやステートを**新規作成**する
3. 有効時は、設定したデフォルト値が自動で反映される
